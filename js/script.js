...
const add_class_on_scroll = () =>
  headerMin.classList.add("header-min") +
  headerShadow.classList.add("header-shadow");
const remove_class_on_scroll = () =>
  headerMin.classList.remove("header-min") +
...
// project swiper
let sliderProjects = new Swiper(".slider-projects", {
  navigation: {
...
// testimonials swiper
let sliderTestimonials = new Swiper(".slider-testimonials", {
  navigation: {
